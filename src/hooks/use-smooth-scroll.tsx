...
export const smooth_scroll_store = createStore<SmoothScrollStore>(
	{
		test_href: null,
		id: null,
	},
...
export function useSmoothScroll() {
	...
	const testhref = useStoreValue(smooth_scroll_store, "test_href");
	const id = useStoreValue(smooth_scroll_store, "id");
