// https://github.com/sersavan/shadcn-multi-select-component (vendor/shadcn-multi-select-component)
				...
				>
											...
											.map((value) => {
												...
												return (
													...
													>
														...
														{/* biome-ignore lint/a11y/useSemanticElements: nested inside the trigger <Button>; a real <button> here would be invalid nested-interactive HTML */}
														<div
															role="button"
															tabIndex={0}
															onClick={(event) => {
					...
					>
						<Command>
							...
							>
								<CommandEmpty>
									{emptyIndicator || "Ni najdenih rezultatov."}
								</CommandEmpty>{" "}
