...
import {
	build_published_article_metadata,
	PublishedArticlePage,
} from "~/components/article/published-article-page";
...
export async function generateMetadata(props: NovicaProps): Promise<Metadata> {
	...
	return build_published_article_metadata(article, requested_slug);
}
...
export default async function NovicaPage(props: NovicaProps) {
	...
	return <PublishedArticlePage article={article} slug={requested_slug} />;
}
