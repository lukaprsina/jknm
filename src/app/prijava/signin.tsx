...
export default function SignIn({ session }: { session: Session | null }) {
	if (!session) {
		return (
			<div className="relative flex h-full min-h-full flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
				...
				<div className={cn("lg:p-8", article_variants())}>
					<div className="mx-auto flex w-full flex-col justify-center space-y-6 px-4">
