{/* 01 Kataster jam */}
import merjenje from "./01 Kataster jam/05 01 01 Merjenje.jpg"
import merjenje_1 from "./01 Kataster jam/05 01 02 Merjenje.jpg"
import kataster_jzs from "./01 Kataster jam/05 01 03 Kataster JZS.jpg"

{/* 02 Izobraževanje */}
import v_majhovka from "./02 Izobraževanje/05 02 01 V. Majhovka.jpg"
import tecaj from "./02 Izobraževanje/05 02 02 Tečaj.jpg"
import klub from "./02 Izobraževanje/05 02 03 Klub.jpg"
import poligon from "./02 Izobraževanje/05 02 04 Poligon.jpg"
import brezno from "./02 Izobraževanje/05 02 05 Brezno.jpg"
import izpit from "./02 Izobraževanje/05 02 06 Izpit.jpg"
import ekskurzija from "./02 Izobraževanje/05 02 07 Ekskurzija.jpg"

{/* 03 Etični kodeks */}
import biser from "./03 Etični kodeks/05 03 01 Biser.jpg"
import jamski_brzec from "./03 Etični kodeks/05 03 02 Jamski brzec.jpg"

{/* 04 Društvo v javnem interesu */}
import kanin_z_luno from "./04 Društvo v javnem interesu/05 04 01 Kanin z Luno.jpg"

{/* 05 Jamarska reševalna služba */}
import resevalna_1 from "./05 Jamarska reševalna služba/05 05 01 Reševalna 1.jpg"
import resevalna_2 from "./05 Jamarska reševalna služba/05 05 02 Reševalna 2.jpg"
import resevalna_3 from "./05 Jamarska reševalna služba/05 05 03 Reševalna 3.jpg"
...
<Image
  src={merjenje}
  alt="Merjenje"
  caption="Merjenje jame nekoč – z naklonomerom, kompasom in metrskim trakom. Na fotografiji Silvo Kristan v Mihovski jami (1993). Foto Mihael Rukše"
/>

**Zapisniki**

Jamarska društva si v prvi vrsti urejajo lasten kataster, ki je zbirka zapisnikov o vseh jamah, ki so jih raziskali člani društva. V našem klubu shranjujemo tudi zapisnike jam, dokumente in druge koristne podatke o jamah z območja dolenjskega krasa, ki so jih raziskali člani drugih društev ali institucij. Kopije elektronsko izpolnjenih zapisnikov oddamo v [Kataster jam JZS](https://www.jamarska-zveza.si/index.php/strokovne-sluzbe/ss-kataster-jam), kjer jih pregledajo in po potrebi pozovejo k njihovi dopolnitvi. Ko so vsi zapisniki izpolnjeni skladno z navodili, jih Kataster jam JZS pošlje na [Inštitut za raziskovanje krasa](https://izrk.zrc-sazu.si/) ZRC SAZU, ki za nove jame določi enoznačno **katastrsko številko** jame.

<Image
  src={merjenje_1}
  alt="Merjenje"
  caption="Merjenje jame danes – z ročnim laserskim razdaljemerom in prenosom meritev na tablični računalnik. Na fotografiji Klemen Mihalič v jami Jelenov hodnik. Foto Mitja Remih"
/>
...
<Image
  src={kataster_jzs}
  alt="Kataster JZS"
  caption="Pomočnik vodje Katastra jam JZS Borivoj Ladišić med delom v Katastru jam. Foto Marko Pršina"
/>
...
[Kataster jam JZS](https://www.jamarska-zveza.si/index.php/strokovne-sluzbe/ss-kataster-jam) je stalna strokovna služba Jamarske zveze Slovenije, katere namen je voditi evidenco jam in dejavnosti jamarskih društev v Sloveniji. Podatke o jamah dobivajo od slovenskih jamarskih društev, Inštituta za raziskovanje krasa ZRC SAZU, tujih jamarskih odprav v Slovenijo ter drugih pravnih in fizičnih oseb. V praksi so pomeni, da JZS in inštitut vodita zbirnik katastrov jam jamarskih društev pri nas. Trenutno (januar 2024) je v Sloveniji registriranih 15095 jam, vsako leto pa je odkritih še vsaj 300, zadnja leta celo več kot 500 novih.

## Izobraževanje

### Postani jamar

Če želite postati jamar, vas vabimo, da se vpišete v naš jamarski tečaj, ki svoja vrata odpira vsako pomlad. Teoretični del poteka na petkovih klubskih večerih, ki mu sledi praktično usposabljanje ob vikendih. Celoten tečaj traja pet zaporednih vikendov. Za termine se dogovarjamo sproti glede na razpoložljiv čas tečajnikov in inštruktorjev. Razpis za jamarski tečaj objavljamo na naši [spletni strani](https://www.jknm.si/), [na FB strani kluba](https://www.facebook.com/jknovomesto) ter v sredstvih javnega obveščanja. Več informacij o reševanju, izobraževanju, tehniki, varstvu jam, katastru jam in drugem si lahko poiščete [na spletnih straneh JZS](https://www.jamarska-zveza.si/index.php/strokovne-sluzbe).

<Image
  src={v_majhovka}
  alt="V. Majhovka"
  caption="Kristalno čisto jezero na dnu brezna Velika Majhovka na Kočevskem Rogu. Foto Marko Majhen"
/>

### Jamarski tečaj

Tečajnike vodimo skozi pester izobraževalni program, s katerim spoznajo značilnosti kraškega sveta, osnove jamarstva ter pridobijo prve izkušnje varnega obiskovanja in raziskovanja jam. Po opravljenem programu kandidat opravi preverjanje znanja in veščin. Z opravljenim teoretičnim in praktičnim delom izpita pridobi naziv _jamarski pripravnik_.
...
<Image
  src={tecaj}
  alt="Tečaj"
  caption="Tečajniki z mentorjem po obisku vodoravne jame Jazbina pri Podturnu. Foto Mateja Kopina"
/>
...
<Image
  src={klub}
  alt="Klub"
  caption="Teoretični del tečaja poteka v klubskih prostorih v Novem mestu. Foto Klemen Mihalič"
/>
...
<Image
  src={poligon}
  alt="Poligon"
  caption="Učenje vrvne tehnike na plezalnem poligonu Malisnica pri Mirni Peči. Foto Marko Pršina"
/>
...
<Image
  src={izpit}
  alt="Izpit"
  caption="Preverjanje znanja: usvojeno znanje kandidatov preverjajo inštruktorji jamarstva. Foto Marko Majhen"
/>
...
- _demonstrator_ za specialna znanja (npr. geologije, biologije, ekologije, fotografije ...)
- _inštruktor jamarstva_

ter **reševalno smer** z nazivi

- _pripravnik jamarske reševalne službe_
- _jamarski reševalec_
- _vodja reševalne ekipe_
- _inštruktor Jamarske reševalne službe_

<Image
  src={ekskurzija}
  alt="Ekskurzija"
  caption="Zadovoljni obrazi tečajnikov in jamarjev ob zaključku jamarske šole. Foto Klemen Mihalič"
/>
...
<Image
  src={biser}
  alt="Biser"
  caption="V številnih naših jamah se skrivajo biseri. Foto Marko Pršina"
/>
...
<Image
  src={jamski_brzec}
  alt="Jamski brzec"
  caption="Varujmo ranljive jamske ekosisteme! Na fotografiji hrošč jamski brzec. Foto Marko Pršina"
/>
...
<Image
  src={resevalna_2}
  alt="Reševalna 2"
  caption="Dvigovanje ponesrečenca med reševalno vajo JRS, reševalnega centra Novo mesto. Foto Tomaž Grdin"
/>
...
<Image
  src={resevalna_3}
  alt="Reševalna 3"
  caption="Zaključni dvig ponesrečenca iz globine 150 metrskega brezna na Kočevskem. Foto Mihael Rukše"
/>
